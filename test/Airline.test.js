...
contract('Airline', accounts => {
    ...
    it('should not allow customers to buy flights if their money is less than the price', async () => {
        let flight = await instance.flights(0);
    ...
    it('Airline gets real balance of contract', async () => {
        let flight = await instance.flights(0);
        let price = flight[1];
    ...
    it('should allow redeem loyalty points for ether', async () => {
